...
public class FacebookActivity extends AppCompatActivity implements RegisterDialog.RegisterDialogListener {
    ...
    @Override
    public void register(final String name_r, final String nickname) throws JSONException { //facebook name 쓰고있음
...
//            postBody.put("nickname", nickname);
            ...
            Request request = new Request.Builder()
                    .url(String.format("%s/api/register/%s/%s/%s", Constants.SERVER_IP, id, name_r, nickname))
                    .post(body)
                    .build();
